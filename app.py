...
# Ajusta la cantidad de <br> si necesitas que bajen más o menos
...
with col_left:
    ...
    # Espacio para separar el de arriba del de abajo
...
with col_center:
    ...
    # --- BOTÓN 3: VIDEO (Centro Abajo - Cruzando el haz) ---
    if st.button("🎥 VIDEO"):
        with st.container():
            st.markdown('<div class="input-box">', unsafe_allow_html=True)
...
with col_right:
    ...
    # Espacio para separar (Alineado con la columna izquierda)
    st.markdown("<br><br><br><br>", unsafe_allow_html=True)
